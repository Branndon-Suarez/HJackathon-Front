...
const ImplementationView = () => {
  ...
  const scripts = [
    {
      id: 1,
      type: 'Instagram DM',
      title: 'Cierre Irresistible',
      content: '"Entiendo perfectamente tu situación, [Nombre]. Muchos de nuestros clientes en RiBuzz empezaron igual..."',
    ...
    },
    {
      ...
      title: 'Agendamiento V1',
      content: '"¡Hola! Qué gusto saludarte. Vi que te interesó el diagnóstico. Tengo estos espacios libres..."',
    ...
    },
    {
      ...
      content: '"¿Estás buscando escalar este mes o solo quieres optimizar lo que ya tienes? Pregunto para..."',
    ...
    },
    {
      ...
      type: 'Seguimiento',
      title: 'Reactivación',
      content: '"Sé que andas a mil, pero no quería dejar pasar esto. El cupo para la implementación se cierra..."',
  ...
  const tasks = [
    {
      id: 1,
      title: 'Validar Scripts ICP',
      desc: 'Revisar métricas de apertura del Q4.',
      time: '09:00 AM',
      priority: 'ALTA',
      statusColor: 'bg-[#E625FF] shadow-[0_0_10px_#E625FF]'
    },
    {
      id: 2,
      title: 'Actualización CRM',
      desc: 'Sincronizar leads del Hiper-Loop.',
      time: '02:30 PM',
      priority: 'MEDIA',
      statusColor: 'bg-[#0FEFFD] shadow-[0_0_10px_#0FEFFD]'
    },
    {
      id: 3,
      title: 'Reporte Semanal',
      desc: 'Compilar datos para la junta directiva.',
      time: '05:00 PM',
      priority: 'BAJA',
  ...
  return (
    <div className="max-w-[1400px] mx-auto py-8 px-6 space-y-10 bg-[#0B0B10] animate-in fade-in duration-700">
      ...
      {/* 1. HEADER ESTILO PLAYBOOK (Titulacion Definida) */}
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-white/5 pb-8">
        <div className="space-y-1">
          ...
          <p className="text-gray-500 text-xs italic font-medium">Control de despliegue estratégico y automatización táctica.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {/* LADO DERECHO: FLUJO DE TAREAS (Estilo Sidebar Playbook) */}
        <div className="lg:col-span-5">
          <div className="bg-[#12131A] border border-white/5 p-8 rounded-[48px] h-full shadow-2xl relative overflow-hidden">
            ...
            <h3 className="text-white font-black text-xs uppercase tracking-[0.3em] mb-8">Flujo de Tareas Operativas</h3>
            ...
            <button className="w-full mt-12 py-5 rounded-[24px] border border-[#0FEFFD]/20 bg-[#0FEFFD]/5 hover:bg-[#0FEFFD]/10 hover:border-[#0FEFFD]/50 transition-all flex items-center justify-center gap-4 group">
              <RefreshCw size={20} className="text-[#0FEFFD] group-hover:rotate-180 transition-transform duration-1000" />
      ...
      <footer className="flex flex-col md:flex-row items-center justify-between p-8 bg-[#12131A] border border-white/5 rounded-[32px] gap-6">
        <div className="flex flex-wrap justify-center gap-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] text-[#0FEFFD] font-black uppercase tracking-[0.3em]">Sincronización Activa</span>
          </div>
          <div className="flex items-center gap-3">
            <CheckCircle2 size={16} className="text-gray-700" />
            <span className="text-[10px] text-gray-600 font-black uppercase tracking-[0.3em]">Scripts de IA validados</span>
          </div>
          <div className="flex items-center gap-3">
